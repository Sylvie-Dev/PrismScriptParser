...
public abstract class PrismLexerBase extends Lexer {
    /**
    ...
    public PrismLexerBase(CharStream input) {
        super(input);
    }
    ...
    {
        if (lastToken == null || lastToken.getType() == PrismLexer.LBRACE)
        {
            String text = getText();
    ...
    protected boolean IsRegexPossible() {
        ...
        switch (this.lastToken.getType()) {
            case PrismLexer.IDENTIFIER:
            case PrismLexer.RAW_IDENTIFIER:
            case PrismLexer.NULL_LITERAL:
            case PrismLexer.BOOLEAN_LITERAL:
            case PrismLexer.KEYWORD_THIS:
            case PrismLexer.LPAREN:
            case PrismLexer.RPAREN:
            case PrismLexer.INTEGER_LITERAL:
            case PrismLexer.FLOAT_LITERAL:
            case PrismLexer.DOUBLE_LITERAL:
            case PrismLexer.STRING_LITERAL:
            case PrismLexer.PLUSPLUS:
            case PrismLexer.MINUSMINUS:
